...
<form  enctype="multipart/form-data">
	...
	<div class="form-group">
        ...
        <br>
	<input type="submit" @click="create_show">
</form>
</div>
</template>
...
export default {
  ...
  methods: {
	...
	async create_show() {
      ...
      try {
        const response = await fetch(`http://127.0.0.1:5000/api/${venue_id}/post/show`, {
          method: "POST",
          headers: {
        ...
        this.$router.push(`/admin/${this.$route.params.admin_id}/dashboard`);
      } catch (error) {
